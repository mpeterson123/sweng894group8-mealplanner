...
<?php } ?>
                                                        ...
                                                        <td classx="max-texts" style="max-width: 250px;"> <a href="/Messages/open/<?php echo $message['id']; ?>" /><?php if (!$message['viewed']) { ?><span class="label label-success m-r-10">New</span><?php } ?> <?php echo substr($message['message'], 0, 28); ?></td>
